...
const FORGE_SPACE_BRAND: BrandIdentity = {
  ...
  colors: {
    ...
    neutral: [
      { name: 'neutral-100', hex: '#f2f2f3', hsl: { h: 262, s: 5, l: 95 }, usage: 'Neutral shade 1' },
      { name: 'neutral-200', hex: '#e5e4e7', hsl: { h: 262, s: 5, l: 90 }, usage: 'Neutral shade 2' },
      { name: 'neutral-300', hex: '#cbc9cf', hsl: { h: 262, s: 5, l: 80 }, usage: 'Neutral shade 3' },
      { name: 'neutral-400', hex: '#98949e', hsl: { h: 262, s: 5, l: 60 }, usage: 'Neutral shade 4' },
      { name: 'neutral-500', hex: '#65616b', hsl: { h: 262, s: 5, l: 40 }, usage: 'Neutral shade 5' },
      { name: 'neutral-600', hex: '#323036', hsl: { h: 262, s: 5, l: 20 }, usage: 'Neutral shade 6' },
      { name: 'neutral-700', hex: '#19181b', hsl: { h: 262, s: 5, l: 10 }, usage: 'Neutral shade 7' },
      { name: 'neutral-800', hex: '#0d0c0d', hsl: { h: 262, s: 5, l: 5 }, usage: 'Neutral shade 8' },
    ],
    semantic: {
      success: { name: 'success', hex: '#22c35d', hsl: { h: 142, s: 70, l: 45 }, usage: 'Success states' },
      warning: { name: 'warning', hex: '#f59f0a', hsl: { h: 38, s: 92, l: 50 }, usage: 'Warning states' },
      error: { name: 'error', hex: '#ef4343', hsl: { h: 0, s: 84, l: 60 }, usage: 'Error states' },
      info: { name: 'info', hex: '#368fe7', hsl: { h: 210, s: 79, l: 56 }, usage: 'Informational states' },
    },
    contrast: {
  ...
  shadows: {
    levels: {
      none: { offsetX: 0, offsetY: 0, blur: 0, spread: 0, color: 'rgba(47, 36, 66, 0)', opacity: 0, cssValue: 'none' },
      sm: { offsetX: 0, offsetY: 1, blur: 2, spread: 0, color: 'rgba(47, 36, 66, 0.05)', opacity: 0.05, cssValue: '1px 1px 2px 0px rgba(47, 36, 66, 0.05)' },
      md: { offsetX: 0, offsetY: 2, blur: 4, spread: -1, color: 'rgba(47, 36, 66, 0.08)', opacity: 0.08, cssValue: '2px 2px 4px -1px rgba(47, 36, 66, 0.08)' },
      lg: { offsetX: 0, offsetY: 4, blur: 8, spread: -2, color: 'rgba(47, 36, 66, 0.1)', opacity: 0.1, cssValue: '4px 4px 8px -2px rgba(47, 36, 66, 0.1)' },
      xl: { offsetX: 0, offsetY: 8, blur: 16, spread: -4, color: 'rgba(47, 36, 66, 0.12)', opacity: 0.12, cssValue: '8px 8px 16px -4px rgba(47, 36, 66, 0.12)' },
      '2xl': { offsetX: 0, offsetY: 16, blur: 32, spread: -8, color: 'rgba(47, 36, 66, 0.15)', opacity: 0.15, cssValue: '16px 16px 32px -8px rgba(47, 36, 66, 0.15)' },
    },
  },
  borders: {
    radii: {
